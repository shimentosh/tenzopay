  ...
  return (
    ...
    >
      <body>
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-50 focus:rounded-card focus:bg-primary focus:px-4 focus:py-2 focus:text-ui focus:text-primary-foreground"
        >
          Skip to content
        </a>
        <ThemeProvider>
