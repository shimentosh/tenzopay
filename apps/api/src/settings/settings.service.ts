...
export const SETTINGS: SettingDefinition[] = [
  ...
  {
    key: 'fee.deposit.flat',
    label: 'Deposit fee, flat part',
    description: 'Charged on every confirmed deposit on top of the percentage.',
    type: 'minor',
    group: 'fee',
    default: '0',
    roles: ['ADMIN', 'FINANCE'] as AdminRole[],
  ...
  {
    key: 'fee.deposit.min',
    label: 'Deposit fee, minimum',
    description: 'Floor applied after the percentage and flat parts. Zero disables it.',
    type: 'minor',
    group: 'fee',
    default: '0',
    roles: ['ADMIN', 'FINANCE'] as AdminRole[],
  },
  {
    ...
    description: 'Ceiling on a single deposit fee. Zero means no cap.',
    type: 'minor',
    group: 'fee',
    default: '0',
    roles: ['ADMIN', 'FINANCE'] as AdminRole[],
  ...
  {
    key: 'fee.transaction.flat',
    label: 'Transaction fee, flat part',
    description: 'Charged per settled card transaction. Reserved at authorization.',
    type: 'minor',
    group: 'fee',
    default: '0',
    roles: ['ADMIN', 'FINANCE'] as AdminRole[],
  ...
  {
    key: 'fee.transaction.bps',
    label: 'Transaction fee, percentage',
    description: 'Basis points of the authorized amount, on top of the flat part.',
    type: 'bps',
    group: 'fee',
    default: '0',
    roles: ['ADMIN', 'FINANCE'] as AdminRole[],
